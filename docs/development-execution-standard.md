...
## 动态字段来源
- location -> yxe locations search
- music -> yxe music search
- challenge -> yxe challenges search
...
```text
YXE_ACCOUNT_INVALID
YXE_UPLOAD_SIGNATURE
YXE_PUBLISH_MISSING_COVER
YXE_PLATFORM_UNSUPPORTED_FIELD
```
...
### 6.2 SKILL.md 面向 Agent

`SKILL.md` 只放 Agent 执行规则：
