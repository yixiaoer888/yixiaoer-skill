# WiFi万能钥匙文章发布参数 (WifiWanNeng Article)
...
```json
{
  ...
  "publishArgs": {
    ...
    "accountForms": [
      {
        "platformAccountId": "acc_wifi_001",
        ...
        "contentPublishForm": {
          ...
          "category": [
            { "yixiaoerId": "cat_001", "yixiaoerName": "资讯", "yixiaoerImageUrl": "", "yixiaoerDesc": "", "viewNum": "0", "raw": {} }
          ]
        }
      }
    ]
...
## 4. DTO 参考
- 后端类: `WifiWanNengArticleForm`
- 文件路径: `apps/server-api/packages/yxr-open-platform/src/models/platform/wifiwanneng.dto.ts`
