# 腾讯微视视频发布 (Publish Tencent Weishi Video)

该指令用于通过视频引擎向腾讯微视分发短视频内容。

## DTO 溯源 (Knowledge from TengXunWeiShiVideoForm)
*逻辑来源: `apps/server-api/packages/yxr-open-platform/src/models/platform/tengxunweishi.dto.ts`*
