...
yxer account-group update group_1 新版核心账号组 --visible-scope all --dry-run
yxer account-group update group_1 新版核心账号组 --visible-scope specific --visible-user user_1 --visible-user user_2 --dry-run
```
